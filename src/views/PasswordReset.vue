<template>
    <v-container step="2" style="height:100vh; max-width: 100vw; background:url('/background.png'); background-size: contain; font-family: oswald!important;">
        ...
        <v-row class="ma-0 mt-6">
            <v-spacer/>
            <v-btn @click="save()" class="px-12 py-6 elevation-0" dark color="#e12826" rounded><strong>Guardar</strong></v-btn>
            <v-spacer/>
        </v-row>
    </v-container>
</template>
