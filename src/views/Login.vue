  ...
  <v-stepper v-model="currentSlide" style="background-color:#f4f5fa!important;">
      <v-stepper-items>
        <v-stepper-content step="login" class="pa-0">
          ...
          <v-container class="ma-0 pa-0" style="max-width: 100vw;  background:url('/background.png'); background-size: contain; font-family:oswald!important;">
            ...
            <v-container class="fill-height pa-0" fluid style="min-height:100vh;">
                ...
                <v-card class="pa-0 mx-auto" style="width:90vw; background:transparent; box-shadow:none;">
                  <v-row style="margin:0; margin-bottom:50px;">
                    <img style="margin:auto;" height="210" src="/logo.png"/>
                  </v-row>
                  ...
                  <v-card-actions class="pa-0">
                    <v-spacer></v-spacer>
                    <v-btn block type="submit" @click="login" class="px-4 py-6 elevation-0" dark color="#e12826" rounded><strong>Acceder</strong></v-btn>
                  </v-card-actions>

                  <v-row style="margin:0; margin-top:25px; margin-bottom:25px;">
                    <v-spacer/>
                    <a @click="currentSlide='recover'" style="color:e12826;">¿Olvidaste tu contraseña?</a>
                    <v-spacer/>
                  </v-row>
                </v-card>
          ...
          <v-container class="ma-0 pa-0" style="max-width: 100vw; background:url('/background.png'); background-size: contain; font-family: oswald!important;">
            ...
            <v-container class="fill-height pa-0" fluid style="min-height:100vh;">
                ...
                <v-card dark class="pa-0 mx-auto" style="width:90vw; background:transparent; box-shadow:none;">
                  <v-row style="margin:0; margin-bottom:50px;">
                    <img style="margin:auto;" height="210" src="/logo-white.png"/>
                  </v-row>
                  ...
                  <v-card-actions class="pa-0">
                    <v-spacer></v-spacer>
                    <v-btn block rounded type="submit" @click="recoverPassword" light color="white" class="px-4 py-6 elevation-0"><strong>Recuperar</strong></v-btn>
                  </v-card-actions>

                  <v-row style="margin:0; margin-top:25px; margin-bottom:25px;">
                    <v-spacer/>
                    <a style="color:#e12826;" @click="currentSlide='login'">Iniciar Sesión</a>
                    <v-spacer/>
                  </v-row>
                </v-card>
